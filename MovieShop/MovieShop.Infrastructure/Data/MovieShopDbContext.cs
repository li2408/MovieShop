...
namespace MovieShop.Infrastructure.Data
{
    ...
    {
        //steps to connect Entity using Fluent API here:
        //1. create a DbSet corresponding to the object here.
        //2. write inside the OnModelCreating
        //3. create the configure method
        ...
        private void ConfigureMovie(EntityTypeBuilder<Movie> builder)
        {
            ...
            builder.Property(m => m.Overview).HasMaxLength(4096); //MAX length is 4096
        ...
        private void ConfigureUser(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasIndex(u => u.Email).IsUnique(); // create an unique index on this one.
